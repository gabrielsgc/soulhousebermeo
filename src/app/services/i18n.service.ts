...
const es: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      { question: '¿Qué incluye el precio?', answer: 'Ropa de cama, toallas, WiFi de fibra, agua caliente y calefacción. Desayuno de cortesía: leche (entera y desnatada), mantequilla, mermelada, pan de molde para tostar si se desea, café, té o manzanilla. No cobramos gastos de gestión ni comisiones de plataformas. Parking disponible (no incluido en el precio).' },
...
const eu: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'Zer sartzen da prezioaren barruan?', answer: 'Oheko arropa, eskuoihalak, WiFi zuntz, ur beroa eta berokuntzea. Kortesiazko gosaria: esnea (osoa eta gantzik gabea), gurina, marmelada, molde-ogia nahi izanez gero tostatzeko, kafea, tea edo kamamila. Ez dugu kudeaketa-gasturik edo plataforma-komisinorik kobratzen. Aparkamendua eskuragarri dago (prezioan ez dago barne).' },
...
const en: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'What is included in the price?', answer: 'Bed linen, towels, fibre WiFi, hot water and heating. Complimentary breakfast: milk (whole and skimmed), butter, jam, sliced bread for toasting if desired, coffee, tea or chamomile. No management fees or platform commissions. Parking available (not included in the price).' },
