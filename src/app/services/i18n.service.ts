...
const es: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'leaf', label: 'Habitación Urdaibai', caption: 'Tranquilidad y naturaleza en la hab. Urdaibai.', img: 'assets/images/bedroom-main.png' },
...
const eu: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'leaf', label: 'Urdaibai Logela', caption: 'Urdaibai logelan lasaitasuna eta natura.', img: 'assets/images/bedroom-main.png' },
...
const en: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'leaf', label: 'Urdaibai Room', caption: 'Peace and nature in the Urdaibai room.', img: 'assets/images/bedroom-main.png' },
...
const fr: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'leaf', label: 'Chambre Urdaibai', caption: 'Calme et nature dans la chambre Urdaibai.', img: 'assets/images/bedroom-main.png' },
