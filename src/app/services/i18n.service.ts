...
const es: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'bed', label: 'Habitación Principal', caption: 'Cama de matrimonio con vistas al puerto y luz natural.', img: 'assets/images/bedroom-main.png' },
...
const eu: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'bed', label: 'Logela Nagusia', caption: 'Seaska-ohea portuko ikuspegiarekin eta argi naturalarekin.', img: 'assets/images/bedroom-main.png' },
...
const en: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'bed', label: 'Master Bedroom', caption: 'Double bed with harbour views and natural light.', img: 'assets/images/bedroom-main.png' },
...
const fr: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'bed', label: 'Chambre principale', caption: 'Lit double avec vue sur le port et lumière naturelle.', img: 'assets/images/bedroom-main.png' },
