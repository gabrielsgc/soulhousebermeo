...
const es: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'bed', label: 'Habitación Principal', caption: 'Cama de matrimonio con vistas a la montaña.', img: 'assets/images/bedroom-main.png' },
      { emoji: 'shower', label: 'Baño', caption: 'Baño moderno con ducha de lluvia.', img: 'assets/images/bathroom.png' },
      { emoji: 'building', label: 'Exterior', caption: 'Fachada de Soul House en el casco histórico de Bermeo.', img: 'assets/images/hero-facade.png' },
  ...
  location: {
    ...
    pois: [
      ...
      { icon: 'train', name: 'Estación EuskoTren Bermeo', dist: '100 m a pie' },
  ...
  faq: {
    ...
    items: [
      ...
      { question: '¿Qué incluye el precio?', answer: 'Ropa de cama, toallas, WiFi de fibra, agua caliente y calefacción. Desayuno de cortesía: leche (entera y desnatada), mantequilla, mermelada, pan de molde para tostar si se desea, café, té o manzanilla. No cobramos gastos de gestión ni comisiones de plataformas. Parking disponible (no incluido en el precio). Avisar con 24 h de antelación al día de la llegada.' },
  ...
  contact: {
    ...
    errorMsg: 'Hubo un error al enviar. Por favor escríbenos directamente a info@soulhousebermeo.com',
...
const eu: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'bed', label: 'Logela Nagusia', caption: 'Matrimonio-ohea mendiaren ikuspegiarekin.', img: 'assets/images/bedroom-main.png' },
      { emoji: 'shower', label: 'Bainugela', caption: 'Euri-dutxa duen bainugela modernoa.', img: 'assets/images/bathroom.png' },
      { emoji: 'building', label: 'Kanpoaldea', caption: 'Soul House-ren fatxada Bermeoko koru historikoan.', img: 'assets/images/hero-facade.png' },
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'Zer sartzen da prezioaren barruan?', answer: 'Oheko arropa, eskuoihalak, WiFi zuntz, ur beroa eta berokuntzea. Kortesiazko gosaria: esnea (osoa eta gantzik gabea), gurina, marmelada, molde-ogia nahi izanez gero tostatzeko, kafea, tea edo kamamila. Ez dugu kudeaketa-gasturik edo plataforma-komisinorik kobratzen. Aparkamendua eskuragarri dago (prezioan ez dago barne). Iritsi aurreko 24 h lehenago jakinarazi.' },
  ...
  contact: {
    ...
    errorMsg: 'Errorea gertatu da bidaltzean. Mesedez idatzi zuzenean info@soulhousebermeo.com helbidera',
...
const en: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'bed', label: 'Master Bedroom', caption: 'Double bed with mountain views.', img: 'assets/images/bedroom-main.png' },
      { emoji: 'shower', label: 'Bathroom', caption: 'Modern bathroom with rainfall shower.', img: 'assets/images/bathroom.png' },
      { emoji: 'building', label: 'Exterior', caption: 'Soul House façade in the historic centre of Bermeo.', img: 'assets/images/hero-facade.png' },
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'What is included in the price?', answer: 'Bed linen, towels, fibre WiFi, hot water and heating. Complimentary breakfast: milk (whole and skimmed), butter, jam, sliced bread for toasting if desired, coffee, tea or chamomile. No management fees or platform commissions. Parking available (not included in the price). Please notify at least 24 h before arrival.' },
  ...
  contact: {
    ...
    errorMsg: 'There was an error sending the form. Please write to us directly at info@soulhousebermeo.com',
...
const fr: Translations = {
  ...
  gallery: {
    ...
    items: [
      ...
      { emoji: 'bed', label: 'Chambre principale', caption: 'Lit double avec vue sur la montagne.', img: 'assets/images/bedroom-main.png' },
      { emoji: 'shower', label: 'Salle de bain', caption: 'Salle de bain moderne avec douche à effet pluie.', img: 'assets/images/bathroom.png' },
      { emoji: 'building', label: 'Extérieur', caption: 'Façade de Soul House dans le centre historique de Bermeo.', img: 'assets/images/hero-facade.png' },
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'Qu\'est-ce qui est inclus dans le prix ?', answer: 'Linge de lit, serviettes, WiFi fibre, eau chaude et chauffage. Petit-déjeuner offert : lait (entier et écrémé), beurre, confiture, pain de mie à griller si souhaité, café, thé ou camomille. Aucuns frais de gestion ni commissions de plateforme. Parking disponible (non inclus dans le prix). Prévenir au moins 24 h avant l\\\'arrivée.' },
  ...
  contact: {
    ...
    errorMsg: 'Une erreur s\'est produite lors de l\'envoi. Veuillez nous écrire directement à info@soulhousebermeo.com',
